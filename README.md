# mic-2
 #### نام ازمایش
 ماشین حساب با وارد کردن اعداد با استفاده از ال ای دی  
   ###هدف روشن شدن ال ای دی با وارد کردن عدد 
### ابزار موردنیاز
مقاومت و ال ای دی ،برد اردینو و برد بورد ،سیم ،کی پد
------
 ### شرح ازمایش
همانند ازمایش قبلی انجام میدهیم
فقط روی پایه10 دیجیتال وصل می کنیم
بعداز مقاومت به سمت زمین نیز سیم وصل می کنیم
کد
```cpp
#include <Keypad.h>
